...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions
{
    ...
    CategoryRecentController *mainController = [[CategoryRecentController alloc] init];
    ...
    //x = [[LoginViewController alloc] init];
...
- (void)presentLogin {
    [self.window.rootViewController presentModalViewController:x animated:NO];
}
